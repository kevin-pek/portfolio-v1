export default function About() {
  return (
    <section className='text-cold-50 mx-auto flex h-screen w-5/6 basis-0 flex-row items-center justify-between gap-10'>
    {/* pan from space to earth setting map overlay showing singapore, room model showing hobbies, forest model */}
      ...
      <div className='flex w-full flex-col items-center gap-4'>
        ...
        <p>In my free time I enjoy a wide array of activites such as exercise, computer art</p>
      </div>
    </section>
  )
}
